...
class InvestmentForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # completed_deposits = Deposit.objects.filter(profile=self.fields['profile'], status='Completed')
        ...
        # completed_investments = Investment.objects.filter(profile=self.fields['profile'], status='Completed')
        ...
        # main_account = MainAccount.objects.filter(profile=self.fields['profile'])
